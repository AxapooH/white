...
/datum/heretic_knowledge/ashen_grasp
	...
	gain_text = "Ночной Страж был первым из них, всё началось с его предательства. \
...
/datum/heretic_knowledge/mark/ash_mark
	...
	desc = "Ваша хватка Мансуса теперь так же накладывает и Метку Пепла. Метка активируется с помощью удара Пепельным клинком.  \
		Когда метка активируется, жертва страдает от урона по выносливости и жутких ожогов. Так же метка накладывается на ближайших к вам людей. \
		Урон уменьшается с каждым новым накладыванием от активации предыдущей метки."
	gain_text = "Он был особенным человеком, смотрящим во тьму. \
		Но это так же был его долг, он всегда блуждал сквозь Манс высоко подняв свой яркий фонарь. \
...
/datum/heretic_knowledge/final/ash_final
	...
	desc = "Ритуал вознесения Пути Пепла. \
		...
		Когда ритуал будет завершен, вы станите Предвестником Пламени, а также получите два навыка. \
	...
	gain_text = "Дозор окончен, Ночной страж сгорел неся его. Но его пламя разгорится вновь, \
