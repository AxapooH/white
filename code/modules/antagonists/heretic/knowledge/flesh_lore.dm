...
/datum/heretic_knowledge/limited_amount/flesh_grasp
	name = "Власть Плоти"
	desc = "Теперь ваша Хватка Мансуса может создать гуля из трупа с душой. \
		Гули имеют только 25 очков здоровья и выглядят в глазах неверных как хаски, но они могут пользоваться Кровавый Клинок. \
		Таким способом можно воскресить лишь раз."
	gain_text = "Мои новоприобретенные порывы вели меня к новым высотам."
...
/datum/heretic_knowledge/limited_amount/flesh_ghoul
	...
	desc = "Позволяет трансмутировать труп и мак в Безмолвного Мертвеца. \
		Безмолвный мертвец не может говорить и имеет 50 очков здоровья, но он может использовать Кровавый Клинок. \
		У вас может быть только два таких прислужника одновременно."
	gain_text = "Мною были найдены запретные темные знания, их незаконченные обрывки... Но это меня не остановит."
	next_knowledge = list(
...
/datum/heretic_knowledge/mark/flesh_mark
	name = "Метка Плоти"
	desc = "Ваша Хватка Масуса теперь накладывает Метку Плоти. Метка активируется, когда вы атакуете жертву Кровавым Клинком. \
...
/datum/heretic_knowledge/summon/raw_prophet
	...
	desc = "Позволяет вам трансмутировать  пару глаз, левую руку и лужу крови в Нечестивого Пророка. \
		Нечестивый Пророк видит на большее расстрояние и имеет возможность смотреть и проходить сквозь стены. Помимо всего прочего \
		он может создать телепатическую сеть для общения, но он крайне слаб и легко может быть уничтожен в бою."
	gain_text = "Продолжать путь в одиночестве было невыносимо. И тогда я призвал Необьяснимого, дабы он помог узреть больше. \
...
/datum/heretic_knowledge/blade_upgrade/flesh
	name = "Истекающая Сталь"
	desc = "Ваш Кровавый Клинок теперь вызывает сильное кровотечение при атаке."
	gain_text = "Но Необьяснимый не был одинок. Он привел меня к Судье. \
		Ко мне наконец пришло просвещение. И тут небеса окропили землю кровью."
...
/datum/heretic_knowledge/summon/stalker
	...
	desc = "Позволяет вам трансмутировать хвост, желудок, язык, ручку и лист бумаги в Преследователя. \
		Преследователи могут проходить сквозь стены, испускать ЭМИ импульс, превращаться в небольших существ. Также они весьма сильны в бою."
	gain_text = "Я смешал свою жадность и желания воедино, дабы призвать невиданное доселе сверхестественное существо. \
		И чем сильнее эта масса плоти изменялась, тем больше она узнавала обо мне. Судья был доволен."
	next_knowledge = list(
...
/datum/heretic_knowledge/final/flesh_final
	...
	gain_text = "Благодаря познаниям Судьи мои силы достигли пика. Трон ждет своего обладателя. \
		Услышьте же меня, жители мира сего, время пришло! Судья ведет мою армию! \
