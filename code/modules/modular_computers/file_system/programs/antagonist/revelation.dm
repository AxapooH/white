/datum/computer_file/program/revelation
	...
	extended_desc = "Скрипт уничтожающий все данные на устройстве, на котором он был запущен. Программа может изменять имя лююое другое для дополнительной скрытности. После взвода, скрипт уничтожит операционную систему при следующем открытии программы."
	size = 13
